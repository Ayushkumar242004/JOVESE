...
function Chat() {
  ...
  return (
    <>
       <Back title="Login form Mentors" />
<div class="flex h-screen antialiased text-gray-800">
    <div class="flex flex-row h-full w-full overflow-x-hidden">
      <div class="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
        <div class="flex flex-row items-center justify-center h-12 w-full">
          <div
            class="flex items-center justify-center rounded-2xl text-indigo-700 bg-lime-200 h-10 w-10"
          >
            <svg
              class="w-6 h-6"
              fill="none"
        ...
        <div
          class="flex flex-col items-center bg-fuchsia-300 border border-gray-200 mt-4 w-full py-6 px-4 rounded-lg"
        >
      ...
      <div class="flex flex-col flex-auto h-full p-6">
        <div
          class="flex flex-col flex-auto flex-shrink-0 rounded-2xl bg-lime-200 h-full p-4"
        >
