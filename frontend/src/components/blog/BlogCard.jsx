  ...
  return (
    <Container>
      ...
      <div className="container3" style={{}}>
        ...
        >
          <h1 style={{ marginTop: "20px", color: "black" }}>
            Our resume builder includes a review from our experts
          </h1>
        </div>
      </div>
      ...
      >
        <img
          alt="Forbes"
          src="https://assets.resume-now.com/lp/_next/image?url=/blobimages/rna/sem/images/optimistic_forbes.svg&amp;w=320&amp;h=undefined&amp;q=100"
          decoding="async"
          data-nimg="intrinsic"
        ></img>
        <img
          alt="USA Today"
          src="https://assets.resume-now.com/lp/_next/image?url=/blobimages/rna/sem/images/optimistic_usa_today.svg&amp;w=320&amp;h=undefined&amp;q=100"
          decoding="async"
          data-nimg="intrinsic"
        ></img>
        <img
          alt="CNBC"
          src="https://assets.resume-now.com/lp/_next/image?url=/blobimages/rna/sem/images/optimistic_cnbc.svg&amp;w=320&amp;h=undefined&amp;q=100"
          decoding="async"
          data-nimg="intrinsic"
        ></img>
        <img
          alt="The New York Times"
          src="https://assets.resume-now.com/lp/_next/image?url=/blobimages/rna/sem/images/optimistic_new_york_times.svg&amp;w=640&amp;h=undefined&amp;q=100"
          decoding="async"
          data-nimg="intrinsic"
        ></img>
        <img
          alt="CNET.com"
          src="https://assets.resume-now.com/lp/_next/image?url=/blobimages/rna/sem/images/optimistic_cnet.svg&amp;w=320&amp;h=undefined&amp;q=100"
          decoding="async"
          data-nimg="intrinsic"
        ></img>
      </div>
